...
%>
        ...
        <tr>
                                    <td width="73"><strong>Status</strong></td>
                ...
                <%
                    ...
                    ResultSet rss = sss.executeQuery("select * from update_ where permission='"+(String)session.getAttribute("fname1")+"' or permission='public' order by dat_ DESC LIMIT 2");
                    while (rss.next()) {
            ...
            <div style="margin-top:90px; margin-bottom: -65px; ">
                ...
                %>
                <div style="margin-top:90px; margin-bottom: -65px; "> <a href="readmore.jsp"> <font color="blue">Read more Posts</font></a></div>
            </div><!--end fragment-2-->
