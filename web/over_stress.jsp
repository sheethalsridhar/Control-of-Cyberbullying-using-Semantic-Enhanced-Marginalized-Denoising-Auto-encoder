...
ResultSet rs2=st2.executeQuery("select * from tweet");           
        while (rs2.next()) {
            String stweet=rs2.getString("msg");
            System.out.println("twet msg======="+stweet);
           String string[]=stweet.split(" ");
            StringBuffer sb=new StringBuffer();
              for(int i=0;i<string.length;i++)
              {
                  sb.append(new Spelling("C:\\Documents and Settings\\Raj\\Desktop\\stress1.txt").correct(string[i])+" ");
              }
              ...
              {
                  t2=t2+1;
//                 System.out.println("====tweet is stress realted & stc "+stc);
                  
              }
              else
                                   {
//                   t3=t3+1;
//                 System.out.println("====tweet is not stress realted & ntc "+ntc);
              }
                           }
              System.out.println("total number of tweets are"+t1);
               System.out.println("====tweet is  stress realted & stc "+t2);
             t3=t1-t2;
              
               System.out.println("====tweet is not stress realted & ntc "+t3);
