...
//            while (rs.next()) {
             ...
             JazzySpellChecker jazzySpellChecker = new JazzySpellChecker();
              ...
              String wordsmine[] = new String[mwords.length-1];
              for(int i =0;i<mwords.length-1;i++){
                  wordsmine[i] = (mwords[i]+" "+mwords[i+1]);
              ...
              String[] blacklistwords = {"kill bill","bill"};
                for(int i = 0 ; i<wordsmine.length;i++){
                  for(int j=0;j<blacklistwords.length;j++)
                  if(wordsmine[i].equals(blacklistwords[j]))
                      flag = 1;
